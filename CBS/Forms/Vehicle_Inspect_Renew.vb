...
Public Class vehicle_inspect_Renew
    ...
    Private Sub vehicle_RoadTax_Renew_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        vhc_rt_note.Text = "Inspection renew on " & todaydate & ""
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        addrcd = "INSERT INTO lorry_inspection_history(vhcinsp_vhcID,vhcinsp_expdate,vhcinsp_note) VALUE(@vhcinsp_vhcID,@vhcinsp_expdate,@vhcinsp_note);"
        updrcd = "UPDATE lorry_inspection SET vhcinsp_inspection ='" & DateTimePicker1.Value.ToString("yyyy-MM-dd") & "' WHERE vhcinsp_vhcID = '" & vhc_ID.Text & "'"
        ...
        Else
            Try
                ...
                cmd.Parameters.AddWithValue("@vhcinsp_vhcID", vhc_ID.Text)
                cmd.Parameters.AddWithValue("@vhcinsp_expdate", newDate.Text)
                cmd.Parameters.AddWithValue("@vhcinsp_note", vhc_rt_note.Text)
                ...
                Vehicle_Inspect.vhc_rt_date.Text = DateTimePicker1.Text

                Me.Close()
                Me.Dispose()

                Vehicle_Inspect.DataGridView1.DataSource = Nothing
                Vehicle_Inspect.BindGrid()
