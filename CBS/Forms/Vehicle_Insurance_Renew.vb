...
Public Class vehicle_Insurance_Renew
    ...
    Private Sub vehicle_Insurance_Renew_Load(sender As Object, e As EventArgs) Handles Me.Load
        newDate.Text = DateTimePicker1.Value.ToString("yyyy-MM-dd")
        todaydate = Date.Now.ToShortDateString
        vhc_rt_note.Text = "Insurance renew on " & todaydate & ""
    End Sub
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        addrcd = "INSERT INTO vehicle_ins_history(vhci_vhcID,vhci_expdate,vhci_note) VALUE(@vhci_vhcID,@vhci_expdate,@vhci_note);"
        updrcd = "UPDATE vehicle SET vhc_insurance ='" & DateTimePicker1.Value.ToString("yyyy-MM-dd") & "' WHERE vhc_ID = '" & vhc_ID.Text & "'"
        ...
        Else
            Try
                ...
                cmd.Parameters.AddWithValue("@vhci_vhcID", vhc_ID.Text)
                cmd.Parameters.AddWithValue("@vhci_expdate", newDate.Text)
                cmd.Parameters.AddWithValue("@vhci_note", vhc_rt_note.Text)
                ...
                Vehicle_Insurance.vhc_rt_date.Text = DateTimePicker1.Text

                Me.Close()
                Me.Dispose()

                Vehicle_Insurance.DataGridView1.DataSource = Nothing
                Vehicle_Insurance.BindGrid()
